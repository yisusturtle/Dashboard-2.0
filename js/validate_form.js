function validarPasswd() { //Para el registro
    ...
    if (espacios) { //Contraseña este compuesta de espacios unicamente ej:("    ")
    ...
    if (contra1Value.length == 0 || contra2Value.length == 0) { //Contraseña tenga 0 caracteres
        error.style.display = "block";
        contra1.style = "border: #B92E10 2px solid";
        contra2.style = "border: #B92E10 2px solid";
        contra1.style.backgroundColor = "salmon";
    ...
    if (contra1Value != contra2Value) { //Contraseña distinta a contraseña2
        error.style.display = "block";
        contra1.style = "border: #B92E10 2px solid";
        contra2.style = "border: #B92E10 2px solid";
        contra1.style.backgroundColor = "salmon";
