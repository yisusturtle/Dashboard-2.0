<?php
    session_start();
    if(empty($_SESSION['email'])){ //Ver si esta logueado
...
<body>
        ...
        <div class="sub-container">
            ...
            <div class="menu-container">
                ...
                <div class="menu-links">
                    ...
                    <div class="link">
                        <a href="pages/dashboard.php" class="menu-link">Dashboard <i class="fab fa-docker iconos-link" id="iconos"></i></a>
                    </div>
                    <div class="link">
                        <a href="#info" class="menu-link">Info <i class="fas fa-server iconos-link" id="iconos"></i></a>
                    </div>
                    <div class="login">
                        <div class="usuario">
    ...
    <div class="container2" id="dashboard">
        <div class="subcontainer2" >
            <!-- <a href="pages/dashboard.php">DASHBOARD</a> -->
            <div class="info-image">
                <img src="src/img/banner-dashboard.png" alt="" srcset="">
            </div>
            <div class="info-text">
                <a href="pages/dashboard.php" class="enlace-info-text">Entrar al DASHBOARD</a>
            </div>
